...
"C:\Program Files\IAR Systems\Embedded Workbench 4.0\common\bin\cspybat" "C:\Program Files\IAR Systems\Embedded Workbench 4.0\430\bin\430proc.dll" "C:\Program Files\IAR Systems\Embedded Workbench 4.0\430\bin\430fet.dll"  %1 --plugin "C:\Program Files\IAR Systems\Embedded Workbench 4.0\430\bin\<libsupport_plugin>" --backend -B "-p" "C:\Program Files\IAR Systems\Embedded Workbench 4.0\430\config\MSP430F2013.ddf" "-d" "fet" "--verify_all" "--erase_main" "--set_putchar_breakpoint" "--set_getchar_breakpoint" "--derivative" "MSP430F20x3" "--vccvoltage=3.0" "--suppress_download" "--attach" "--protocol" "spy-bi-wire" "--eem" "EMEX_LOW" "--port" "Automatic" "--connection" "ti_usb" "--settlingtime=0" 
